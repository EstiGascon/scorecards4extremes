 #!/bin/bash
#SBATCH --job-name=mars_2t_det_rd
#SBATCH --output=mars_2t_det_rd_%j.out
#SBATCH --error=mars_2t_det_rd_%j.err
#SBATCH --time=48:00:00
#SBATCH --mem=8G
#SBATCH --cpus-per-task=1

# ==============================================================================
# Retrieve 2 m temperature (deterministic) from MARS/FDB for rd experiments
...
# ==============================================================================
# Usage (interactive):  bash retrieve_2t_det_rd.sh
# Usage (batch):        sbatch retrieve_2t_det_rd.sh
# ==============================================================================
