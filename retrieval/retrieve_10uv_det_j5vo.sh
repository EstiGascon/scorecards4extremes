#!/bin/bash
#SBATCH --job-name=mars_10uv_j5vo
#SBATCH --output=mars_10uv_j5vo_%j.out
#SBATCH --error=mars_10uv_j5vo_%j.err
#SBATCH --time=48:00:00
#SBATCH --mem=8G
#SBATCH --cpus-per-task=1

# ==============================================================================
# Retrieve 10 m U and V wind components (deterministic) for j5vo
...
# ==============================================================================
# Usage (interactive):  bash retrieve_10uv_det_j5vo.sh
# Usage (batch):        sbatch retrieve_10uv_det_j5vo.sh
# ==============================================================================
...
echo "=============================================="
echo "MARS 10UV DET (j5vo) retrieval"
