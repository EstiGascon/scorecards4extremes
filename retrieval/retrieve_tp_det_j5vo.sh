#!/bin/bash
#SBATCH --job-name=mars_tp_j5vo
#SBATCH --output=mars_tp_j5vo_%j.out
#SBATCH --error=mars_tp_j5vo_%j.err
#SBATCH --time=48:00:00
#SBATCH --mem=8G
#SBATCH --cpus-per-task=1

# ==============================================================================
# Retrieve total precipitation (deterministic) for j5vo
...
# ==============================================================================
# Usage (interactive):  bash retrieve_tp_det_j5vo.sh
# Usage (batch):        sbatch retrieve_tp_det_j5vo.sh
# ==============================================================================
...
echo "=============================================="
echo "MARS TP DET (j5vo) retrieval"
