#!/bin/bash
#SBATCH --job-name=mars_2t_ens
#SBATCH --output=mars_2t_ens_%j.out
#SBATCH --error=mars_2t_ens_%j.err
#SBATCH --time=24:00:00
#SBATCH --mem=8G
#SBATCH --cpus-per-task=1

# ==============================================================================
# Retrieve IFS-ENS and AIFS-ENS 2-metre temperature from MARS
...
# ==============================================================================
# Usage (interactive):  bash retrieve_2t_ens.sh
# Usage (batch):        sbatch retrieve_2t_ens.sh
# ==============================================================================
...
MARSEOF
    ...
    # ----------------------------------------------------------------- AIFS-ENS
    aifs_out="$AIFS_DIR/2t_aifs_ens_${current}.grib"
